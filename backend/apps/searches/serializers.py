...
class SearchProfileSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data: dict[str, object]) -> SearchProfile:
        places = validated_data.pop("important_places", [])
        notification_data = validated_data.pop("notification_preference", {})
    ...
    def update(self, instance: SearchProfile, validated_data: dict[str, object]) -> SearchProfile:
        places = validated_data.pop("important_places", None)
        notification_data = validated_data.pop("notification_preference", None)
